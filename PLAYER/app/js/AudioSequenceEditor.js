function AudioLayerSequenceEditor(elementContext)
{
    ...
    this.canvasWidth = elementContext.parentNode.parentNode.clientWidth - 90;
    ...
    this.colorInactiveTop = "#838EA2";
    this.colorInactiveBottom = "#838EA2";
    // colors when the mouse is inside of the editor box
    this.colorActiveTop = "#838EA2";
    this.colorActiveBottom = "#838EA2";
    // color when the mouse is pressed during inside of the editor box
    this.colorMouseDownTop = "#838EA2";
    this.colorMouseDownBottom = "#838EA2";
    // color of the selection frame
    this.colorSelectionStroke = "#838EA2";
    this.colorSelectionFill = "#838EA2";
    ...
    this.createEditor = function createEditor()
    {
        ...
        this.canvasReference.style['border'] = '1px solid #838EA2';
        this.canvasReference.style['margin'] = '5px 0px';
    ...
    this.paintEmpty = function paintEmpty(canvasContext)
    {
        ...
        this.paintTextWithShadow("Déposer votre fichier audio", canvasContext.canvas.clientWidth / 2.4, canvasContext.canvas.clientHeight / 2.2, "rgba(255,255,255,1)", canvasContext);
    ...
    this.paintWaveform = function paintWaveform(canvasContext)
    {
        ...
        canvasContext.strokeStyle = "#575757";                
    ...
    this.paintTextInfo = function paintTextInfo(canvasContext)
    {
        this.paintTextWithShadow("Selection: " + this.selectionStart +
                                 " - " + this.selectionEnd +
                                 " (" + (this.selectionEnd - this.selectionStart) + ")", 1, 10, "rgb(255,255,255)", canvasContext);
    }
